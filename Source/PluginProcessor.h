...
/**
*/
class AudioPluginFadeInVolumeEffectAudioProcessor : public juce::AudioProcessor
{
public:
    //==============================================================================
    AudioPluginFadeInVolumeEffectAudioProcessor();
    ~AudioPluginFadeInVolumeEffectAudioProcessor() override;
